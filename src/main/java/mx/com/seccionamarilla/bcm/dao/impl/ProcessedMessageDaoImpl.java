...
public class ProcessedMessageDaoImpl implements IProcessedMessageDao {
	...
	public int insert(ProcessedMessage pm) {
		String sql = """
				MERGE INTO KAFKA_PROCESSED_MESSAGES t
				USING (
	...
	public int updateStatusOut(Long id, String statusOut, String errorOut, String msgId, String msgValue,
		...
		String sql = "UPDATE KAFKA_PROCESSED_MESSAGES SET STATUS_OUT = ?, ERROR_OUT = ?, PROCESSED_AT = current_timestamp, MSG_ID = ?, MSG_ID_VALUE = ?, MSG_CODE = ?, MSG_OUT = ? WHERE PROCESSED_MESSAGES_ID = ?";
	...
	public void insertCompleto(ProcessedMessage pm, Long id) {
		String sql = "INSERT INTO KAFKA_PROCESSED_MESSAGES ("
		        + "PROCESSED_MESSAGES_ID, "
		        + "TOPIC_NAME, "
		        + "PAYLOAD, "
		        + "MSG_ID, "
		...
		jdbcTemplate.update(
		        ...
		        id,
		        pm.getTopicName(),
		        pm.getPayload(),        // CLOB → String sin problema
		        pm.getMsgId(),
		        pm.getMsgIdValue(),
		        pm.getMsgCode(),
		        pm.getErrorOut(),
